...
class ViewScreenSubjectPage extends StatefulWidget {
  PageContext context;

  ViewScreenSubjectPage({this.context});

  @override
  _ViewScreenSubjectPageState createState() => _ViewScreenSubjectPageState();
}

class _ViewScreenSubjectPageState extends State<ViewScreenSubjectPage> {
  TextEditingController _titleController = TextEditingController();
  TextEditingController _subTitleController = TextEditingController();
  TextEditingController _hrefController = TextEditingController();
  ScreenSubjectOR _subject;
  String _leading;

  @override
  void initState() {
    _subject = widget.context.parameters['subject'];
    if (_subject != null) {
      _titleController.text = _subject.title;
      _hrefController.text = _subject.href;
      _subTitleController.text = _subject.subTitle;
      if (mounted) {
        setState(() {});
      }
    }
  ...
  Future<void> _update() async {
    ...
    await screenRemote.updateSubject(_subject.id, _titleController.text,
        _subTitleController.text, _leading, _hrefController.text);
