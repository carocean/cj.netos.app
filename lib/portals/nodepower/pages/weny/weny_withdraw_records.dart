...
class PlatformWithdrawRecordsPage extends StatefulWidget {
  PageContext context;

  PlatformWithdrawRecordsPage({this.context});

  @override
  _PlatformWithdrawRecordsPageState createState() => _PlatformWithdrawRecordsPageState();
}

class _PlatformWithdrawRecordsPageState extends State<PlatformWithdrawRecordsPage> {
  BankInfo _bank;
