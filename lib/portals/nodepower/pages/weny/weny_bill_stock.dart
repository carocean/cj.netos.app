...
class PlatformStockWenyBill extends StatefulWidget {
  PageContext context;

  PlatformStockWenyBill({this.context});

  @override
  _PlatformStockWenyBillState createState() => _PlatformStockWenyBillState();
}

class _PlatformStockWenyBillState extends State<PlatformStockWenyBill>
  ...
  Future<void> _loadFundIndexer() async {
    ...
    _totalInOfMonth =
        await wenyBillRemote.totalInStockBillOfMonth(_bank.id, _selected);
    _totalOutOfMonth =
        await wenyBillRemote.totalOutStockBillOfMonth(_bank.id, _selected);
  }
                            ...
                            children: <Widget>[
                              Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Text(
                                    '₩${(_totalInOfMonth ?? 0).toStringAsFixed(14)}',
                                    style: TextStyle(
                                      fontWeight: FontWeight.w500,
                                    ),
                                  ),
                              ...
                              Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Text(
                                    '₩${(_totalOutOfMonth ?? 0).toStringAsFixed(14)}',
                                    style: TextStyle(
                                      fontWeight: FontWeight.w500,
                                    ),
                                  ),
...
class _StockBillTabView extends StatefulWidget {
  PageContext context;
  BankInfo bank;
  Stream datePicker;
  ...
  @override
  _StockBillTabViewState createState() => _StockBillTabViewState();
}

class _StockBillTabViewState extends State<_StockBillTabView> {
  List<WenyStockBillOR> _stockBills = [];
  EasyRefreshController _controller;
  ...
  Future<void> _onload() async {
    ...
    var stockBill;
    if (widget.order > -1) {
      stockBill = await wenyBillRemote.pageStockBillOfMonth(
          widget.bank.id, _selectedDateTime, widget.order, _limit, _offset);
    } else {
      stockBill = await wenyBillRemote.getStockBillOfMonth(
    ...
    _stockBills.addAll(stockBill);
    _offset += stockBill.length;
    if (mounted) {
      setState(() {});
    }
  }
  ...
  @override
  void didUpdateWidget(_StockBillTabView oldWidget) {
                                        ...
                                        Padding(
                                          ...
                                          child: Wrap(
                                            ...
                                            children: <Widget>[
                                              ...
                                              Text(
                                                '${(bill.stock ?? 0.0).toStringAsFixed(14)}',
                                              ),
                                            ],
                                          ),
                                        ),
                                        Padding(
                                          ...
                                          child: Wrap(
                                            ...
                                            children: <Widget>[
                                              ...
                                              Text(
                                                '${(bill.balance ?? 0.0).toStringAsFixed(14)}',
                                              ),
                                            ],
                                          ),
                                        ),
  ...
  _getOrderType(WenyStockBillOR bill) {
    switch(bill.order) {
      case 0:
        return '申购单';
      case 1:
