...
class PlatformFreezenWenyAccount extends StatefulWidget {
  PageContext context;

  PlatformFreezenWenyAccount({this.context});

  @override
  _PlatformFreezenWenyAccountState createState() => _PlatformFreezenWenyAccountState();
}

class _PlatformFreezenWenyAccountState extends State<PlatformFreezenWenyAccount> {
  BankInfo _bank;
