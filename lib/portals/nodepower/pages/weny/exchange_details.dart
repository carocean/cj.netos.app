...
class PlatformExchangeDetails extends StatefulWidget {
  PageContext context;

  PlatformExchangeDetails({this.context});

  @override
  _PlatformExchangeDetailsState createState() => _PlatformExchangeDetailsState();
}

class _PlatformExchangeDetailsState extends State<PlatformExchangeDetails> {
  Timer _timer;
