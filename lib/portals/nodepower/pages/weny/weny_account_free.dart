...
class PlatformFreeWenyAccount extends StatefulWidget {
  PageContext context;

  PlatformFreeWenyAccount({this.context});

  @override
  _PlatformFreeWenyAccountState createState() => _PlatformFreeWenyAccountState();
}

class _PlatformFreeWenyAccountState extends State<PlatformFreeWenyAccount> {
  BankInfo _bank;
