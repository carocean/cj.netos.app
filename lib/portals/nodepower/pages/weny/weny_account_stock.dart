...
class PlatformStockWenyAccount extends StatefulWidget {
  PageContext context;

  PlatformStockWenyAccount({this.context});

  @override
  _PlatformStockWenyAccountState createState() => _PlatformStockWenyAccountState();
}

class _PlatformStockWenyAccountState extends State<PlatformStockWenyAccount> {
  BankInfo _bank;
