...
class PlatformInvestRecordsPage extends StatefulWidget {
  PageContext context;

  PlatformInvestRecordsPage({this.context});

  @override
  _PlatformInvestRecordsPageState createState() => _PlatformInvestRecordsPageState();
}

class _PlatformInvestRecordsPageState extends State<PlatformInvestRecordsPage> {
