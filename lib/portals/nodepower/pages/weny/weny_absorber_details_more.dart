...
class PlatformWenyAbsorberDetailsMorePage extends StatefulWidget {
  PageContext context;

  PlatformWenyAbsorberDetailsMorePage({this.context});

  @override
  _PlatformWenyAbsorberDetailsMorePageState createState() => _PlatformWenyAbsorberDetailsMorePageState();
}

class _PlatformWenyAbsorberDetailsMorePageState extends State<PlatformWenyAbsorberDetailsMorePage> {
