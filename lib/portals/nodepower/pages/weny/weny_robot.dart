...
class PlatformRobotPage extends StatefulWidget {
  PageContext context;

  PlatformRobotPage({this.context});

  @override
  _PlatformRobotPageState createState() => _PlatformRobotPageState();
}

class _PlatformRobotPageState extends State<PlatformRobotPage> {
  BankInfo _bank;
