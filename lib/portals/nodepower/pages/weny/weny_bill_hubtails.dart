...
class PlatformHubTailsWenyBill extends StatefulWidget {
  PageContext context;

  PlatformHubTailsWenyBill({this.context});

  @override
  _PlatformHubTailsWenyBillState createState() => _PlatformHubTailsWenyBillState();
}

class _PlatformHubTailsWenyBillState extends State<PlatformHubTailsWenyBill>
