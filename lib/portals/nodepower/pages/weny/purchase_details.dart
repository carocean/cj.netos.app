...
class PlatformPurchaseDetails extends StatefulWidget {
  PageContext context;

  PlatformPurchaseDetails({this.context});

  @override
  _PlatformPurchaseDetailsState createState() => _PlatformPurchaseDetailsState();
}

class _PlatformPurchaseDetailsState extends State<PlatformPurchaseDetails> {
  Timer _timer;
  PurchaseOR _purch;
  BankInfo _bank;
