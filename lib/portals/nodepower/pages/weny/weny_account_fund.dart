...
class PlatformFundWenyAccount extends StatefulWidget {
  PageContext context;

  PlatformFundWenyAccount({this.context});

  @override
  _PlatformFundWenyAccountState createState() => _PlatformFundWenyAccountState();
}

class _PlatformFundWenyAccountState extends State<PlatformFundWenyAccount> {
  BankInfo _bank;
