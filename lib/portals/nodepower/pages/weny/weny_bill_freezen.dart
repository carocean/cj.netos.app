...
class PlatformFreezenWenyBill extends StatefulWidget {
  PageContext context;

  PlatformFreezenWenyBill({this.context});

  @override
  _PlatformFreezenWenyBillState createState() => _PlatformFreezenWenyBillState();
}

class _PlatformFreezenWenyBillState extends State<PlatformFreezenWenyBill>
