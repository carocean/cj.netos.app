...
class PlatformWenyBankWidget extends StatefulWidget {
  PageContext context;

  PlatformWenyBankWidget({this.context});

  @override
  _PlatformWenyBankWidgetState createState() => _PlatformWenyBankWidgetState();
}

class _PlatformWenyBankWidgetState extends State<PlatformWenyBankWidget>
      ...
      child: Column(
        children: <Widget>[
          ...
          _getCardItem(
            title: '账金账户',
            tips:
            '¥${((_shuntBuckets?.platformAmount ?? 0.00) / 100).toStringAsFixed(2)}',
            onTap: () {
