...
class PlatformGeoAbsorberRecipientsRecordsPage extends StatefulWidget {
  PageContext context;

  PlatformGeoAbsorberRecipientsRecordsPage({this.context});

  @override
  _RecipientsRecordsState createState() => _RecipientsRecordsState();
}

class _RecipientsRecordsState extends State<PlatformGeoAbsorberRecipientsRecordsPage> {
