...
class IspPurchaseRecordPage extends StatefulWidget {
  PageContext context;

  IspPurchaseRecordPage({this.context});

  @override
  _IspPurchaseRecordPageState createState() => _IspPurchaseRecordPageState();
}

class _IspPurchaseRecordPageState extends State<IspPurchaseRecordPage> {
  Timer _timer;
  String _recordSn;
  PurchaseOR _purch;
  BankInfo _bank;
...
class IspExchangeRecordPage extends StatefulWidget {
  PageContext context;

  IspExchangeRecordPage({this.context});

  @override
  _IspExchangeRecordPageState createState() => _IspExchangeRecordPageState();
}

class _IspExchangeRecordPageState extends State<IspExchangeRecordPage> {
  Timer _timer;
  String _recordSn;
...
class IspShuntRecordPage extends StatefulWidget {
  PageContext context;

  IspShuntRecordPage({this.context});

  @override
  _IspShuntRecordPageState createState() => _IspShuntRecordPageState();
}

class _IspShuntRecordPageState extends State<IspShuntRecordPage> {
  Timer _timer;
  String _recordSn;
  ShuntOR _shunt;
  BankInfo _bank;
