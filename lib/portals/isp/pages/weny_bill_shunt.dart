...
class IspShuntWenyBill extends StatefulWidget {
  PageContext context;

  IspShuntWenyBill({this.context});

  @override
  _IspShuntWenyBillState createState() => _IspShuntWenyBillState();
}

class _IspShuntWenyBillState extends State<IspShuntWenyBill>
