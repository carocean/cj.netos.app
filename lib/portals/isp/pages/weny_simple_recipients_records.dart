...
class IspSimpleAbsorberRecipientsRecordsPage extends StatefulWidget {
  PageContext context;

  IspSimpleAbsorberRecipientsRecordsPage({this.context});
...
class _RecipientsRecordsState
    extends State<IspSimpleAbsorberRecipientsRecordsPage> {
