...
class IspPurchaseDetails extends StatefulWidget {
  PageContext context;

  IspPurchaseDetails({this.context});

  @override
  _IspPurchaseDetailsState createState() => _IspPurchaseDetailsState();
}

class _IspPurchaseDetailsState extends State<IspPurchaseDetails> {
  Timer _timer;
  PurchaseOR _purch;
  BankInfo _bank;
