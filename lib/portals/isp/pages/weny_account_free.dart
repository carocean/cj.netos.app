...
class IspFreeWenyAccount extends StatefulWidget {
  PageContext context;

  IspFreeWenyAccount({this.context});

  @override
  _IspFreeWenyAccountState createState() => _IspFreeWenyAccountState();
}

class _IspFreeWenyAccountState extends State<IspFreeWenyAccount> {
  BankInfo _bank;
