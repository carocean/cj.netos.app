...
class IspRobotAbsorbersPage extends StatefulWidget {
  PageContext context;

  IspRobotAbsorbersPage({this.context});

  @override
  _IspRobotAbsorbersPageState createState() => _IspRobotAbsorbersPageState();
}

class _IspRobotAbsorbersPageState extends State<IspRobotAbsorbersPage> {
  BankInfo _bank;
