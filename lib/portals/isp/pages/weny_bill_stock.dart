...
class IspStockWenyBill extends StatefulWidget {
  PageContext context;

  IspStockWenyBill({this.context});

  @override
  _IspStockWenyBillState createState() => _IspStockWenyBillState();
}

class _IspStockWenyBillState extends State<IspStockWenyBill>
