...
class IspFreezenWenyBill extends StatefulWidget {
  PageContext context;

  IspFreezenWenyBill({this.context});

  @override
  _IspFreezenWenyBillState createState() => _IspFreezenWenyBillState();
}

class _IspFreezenWenyBillState extends State<IspFreezenWenyBill>
