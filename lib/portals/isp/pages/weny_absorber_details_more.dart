...
class IspWenyAbsorberDetailsMorePage extends StatefulWidget {
  PageContext context;

  IspWenyAbsorberDetailsMorePage({this.context});

  @override
  _IspWenyAbsorberDetailsMorePageState createState() => _IspWenyAbsorberDetailsMorePageState();
}

class _IspWenyAbsorberDetailsMorePageState extends State<IspWenyAbsorberDetailsMorePage> {
