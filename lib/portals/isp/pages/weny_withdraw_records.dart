...
class IspWithdrawRecordsPage extends StatefulWidget {
  PageContext context;

  IspWithdrawRecordsPage({this.context});

  @override
  _IspWithdrawRecordsPageState createState() => _IspWithdrawRecordsPageState();
}

class _IspWithdrawRecordsPageState extends State<IspWithdrawRecordsPage> {
  BankInfo _bank;
