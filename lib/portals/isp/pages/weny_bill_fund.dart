...
class IspFundWenyBill extends StatefulWidget {
  PageContext context;

  IspFundWenyBill({this.context});

  @override
  _IspFundWenyBillState createState() => _IspFundWenyBillState();
}

class _IspFundWenyBillState extends State<IspFundWenyBill>
