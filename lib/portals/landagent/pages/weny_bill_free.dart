...
class LAFreeWenyBill extends StatefulWidget {
  PageContext context;

  LAFreeWenyBill({this.context});

  @override
  _LAFreeWenyBillState createState() => _LAFreeWenyBillState();
}

class _LAFreeWenyBillState extends State<LAFreeWenyBill>
