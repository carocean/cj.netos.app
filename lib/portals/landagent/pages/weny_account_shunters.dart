...
class ShuntersWenyAccount extends StatefulWidget {
  PageContext context;

  ShuntersWenyAccount({this.context});

  @override
  _ShuntersWenyAccountState createState() => _ShuntersWenyAccountState();
}

class _ShuntersWenyAccountState extends State<ShuntersWenyAccount> {
  BankInfo _bank;
  ...
  void initState() {
    ...
    _enableButton = _shuntBuckets.laAmount > 0;
    super.initState();
  }
            ...
            children: <Widget>[
              ...
              Text(
                ...
                style: TextStyle(
                  fontSize: 40,
                  fontWeight: FontWeight.bold,
                  color: _shuntBuckets?.laAmount < 0
                      ? Colors.green
                      : _shuntBuckets?.laAmount == 0 ? null : Colors.redAccent,
                ),
              ),
            ],
          ),
