...
class LAStockWenyBill extends StatefulWidget {
  PageContext context;

  LAStockWenyBill({this.context});

  @override
  _LAStockWenyBillState createState() => _LAStockWenyBillState();
}

class _LAStockWenyBillState extends State<LAStockWenyBill>
