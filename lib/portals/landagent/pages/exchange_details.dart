...
class LAExchangeDetails extends StatefulWidget {
  PageContext context;

  LAExchangeDetails({this.context});

  @override
  _LAExchangeDetailsState createState() => _LAExchangeDetailsState();
}

class _LAExchangeDetailsState extends State<LAExchangeDetails> {
  Timer _timer;
