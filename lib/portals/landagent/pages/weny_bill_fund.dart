...
class LAFundWenyBill extends StatefulWidget {
  PageContext context;

  LAFundWenyBill({this.context});

  @override
  _LAFundWenyBillState createState() => _LAFundWenyBillState();
}

class _LAFundWenyBillState extends State<LAFundWenyBill>
