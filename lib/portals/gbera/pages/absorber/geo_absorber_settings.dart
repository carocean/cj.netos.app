...
class GeoAbsorberSettingsPage extends StatefulWidget {
  PageContext context;

  GeoAbsorberSettingsPage({this.context});

  @override
  _GeoAbsorberSettingsPageState createState() => _GeoAbsorberSettingsPageState();
}

class _GeoAbsorberSettingsPageState extends State<GeoAbsorberSettingsPage> {
