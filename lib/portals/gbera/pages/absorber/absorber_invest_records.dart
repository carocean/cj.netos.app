...
class AbsorberInvestRecordsPage extends StatefulWidget {
  PageContext context;

  AbsorberInvestRecordsPage({this.context});

  @override
  _AbsorberInvestRecordsPageState createState() => _AbsorberInvestRecordsPageState();
}

class _AbsorberInvestRecordsPageState extends State<AbsorberInvestRecordsPage> {
