...
class _GeoViewReceptorState extends State<GeoViewReceptor> {
  ...
  void _showWhiteAppBar(GberaPersistentHeaderDelegate appBar,
    ...
    if (showTitle) {
      appBar.title = Text(
        _receptorInfo.category == 'mobiles' ? '${_owner.nickName}的地圈' : _receptorInfo.title,
        style: TextStyle(
          color: Colors.white,
        ),
      );
                      ...
                      children: <Widget>[
                        ...
                        Flex(
                          ...
                          children: <Widget>[
                            Text.rich(
                              TextSpan(
                                text:  widget.receptorInfo.category == 'mobiles' ? '${widget.owner.nickName}的地圈' : widget.receptorInfo.title,
                                children: [],
                              ),
                              softWrap: true,
