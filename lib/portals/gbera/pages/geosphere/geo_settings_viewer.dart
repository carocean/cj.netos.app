...
class GeoSettingsViewer extends StatefulWidget {
  PageContext context;

  GeoSettingsViewer({this.context});

  @override
  _GeoSettingsViewerState createState() => _GeoSettingsViewerState();
}

class _GeoSettingsViewerState extends State<GeoSettingsViewer> {
