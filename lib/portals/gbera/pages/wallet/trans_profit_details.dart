...
class TransProfitDetails extends StatefulWidget {
  PageContext context;

  TransProfitDetails({this.context});

  @override
  _TransProfitDetailsState createState() => _TransProfitDetailsState();
}

class _TransProfitDetailsState extends State<TransProfitDetails> {
  List<TransProfitActivityOR> _activities = [];
  Timer _timer;
  TransProfitOR _record;
  WenyBank _bank;

  @override
  void initState() {
    _record = widget.context.parameters['transProfit'];
  ...
  Future<void> _loadActivities() async {
    ...
    _activities = await recordRemote.getTransProfitActivies(_record.sn);
  }

  @override
  Widget build(BuildContext context) {
    TransProfitOR record = _record;
    WenyBank bank = _bank;
  ...
  Widget _AmountCard(TransProfitOR record, WenyBank bank) {
    return Container(
  ...
  Widget _DetailsCard(TransProfitOR record, WenyBank bank) {
    var minWidth = 70.00;
    return Container(
      color: Colors.white,
      child: ListView(
