...
class DepositTrialDetails extends StatefulWidget {
  PageContext context;

  DepositTrialDetails({this.context});

  @override
  _DepositTrialDetailsState createState() => _DepositTrialDetailsState();
}

class _DepositTrialDetailsState extends State<DepositTrialDetails> {
  List<DepositTrialActivityOR> _activities = [];
  Timer _timer;
  DepositTrialOR _record;
  MyWallet _wallet;

  @override
  void initState() {
    _record = widget.context.parameters['depositTrial'];
  ...
  Future<void> _loadActivities() async {
    ...
    _activities = await recordRemote.getDepositTrialActivies(_record.sn);
  }

  @override
  Widget build(BuildContext context) {
    DepositTrialOR record = _record;
  ...
  Widget _AmountCard(DepositTrialOR record, MyWallet wallet) {
    return Container(
  ...
  Widget _DetailsCard(DepositTrialOR record, MyWallet wallet) {
    var minWidth = 80.00;
    return Container(
      color: Colors.white,
      child: ListView(
