...
class TrialBill extends StatefulWidget {
  PageContext context;

  TrialBill({this.context});

  @override
  _TrialBillState createState() => _TrialBillState();
}

class _TrialBillState extends State<TrialBill> {
  MyWallet _wallet;
  int _limit = 50, _offset = 0;
  List<TrialBillOR> _bills = [];
  ...
  _forwardDetails(TrialBillOR bill) async {
