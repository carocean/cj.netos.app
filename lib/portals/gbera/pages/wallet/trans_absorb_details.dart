...
class TransAbsorbDetails extends StatefulWidget {
  PageContext context;

  TransAbsorbDetails({this.context});

  @override
  _TransAbsorbDetailsState createState() => _TransAbsorbDetailsState();
}

class _TransAbsorbDetailsState extends State<TransAbsorbDetails> {
  List<TransAbsorbActivityOR> _activities = [];
  Timer _timer;
  TransAbsorbOR _record;
  MyWallet _wallet;

  @override
  void initState() {
    _record = widget.context.parameters['transAbsorb'];
  ...
  Future<void> _loadActivities() async {
    ...
    _activities = await recordRemote.getTransAbsorbActivies(_record.sn);
  }

  @override
  Widget build(BuildContext context) {
    TransAbsorbOR record = _record;
  ...
  Widget _AmountCard(TransAbsorbOR record, MyWallet wallet) {
    return Container(
  ...
  Widget _DetailsCard(TransAbsorbOR record, MyWallet wallet) {
    var minWidth = 70.00;
    return Container(
      color: Colors.white,
      child: ListView(
