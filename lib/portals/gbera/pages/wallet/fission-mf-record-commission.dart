...
class FissionMFRecordCommissionPage extends StatefulWidget {
  PageContext context;

  FissionMFRecordCommissionPage({this.context});
...
class _FissionMFRecordRechargePageState
    extends State<FissionMFRecordCommissionPage> {
  FissionMFCommissionRecordOR _record;
  ...
  Future<void> _load() async {
    ...
    _record = await recordRemote.getDepositCommissionRecord(sn);
    if (mounted) {
      setState(() {
        _isLoading = false;
      });
