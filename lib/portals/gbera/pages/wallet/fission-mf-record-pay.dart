...
class FissionMFRecordPayPage extends StatefulWidget {
  PageContext context;

  FissionMFRecordPayPage({this.context});

  @override
  _FissionMFRecordPayPageState createState() => _FissionMFRecordPayPageState();
}

class _FissionMFRecordPayPageState extends State<FissionMFRecordPayPage> {
  FissionMFPayRecordOR _record;
  ...
  Future<void> _load() async {
    ...
    _record = await recordRemote.getPayRecord(sn);
    if (mounted) {
      setState(() {
        _isLoading = false;
      });
