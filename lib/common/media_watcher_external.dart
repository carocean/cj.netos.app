...
class MediaWatcherExternal extends StatefulWidget {
  MediaWatcherExternal({
    this.pageContext,
  });
  ...
  State<StatefulWidget> createState() {
    return _MediaWatcherExternalState();
  }
}

class _MediaWatcherExternalState extends State<MediaWatcherExternal> {
  int currentIndex;
