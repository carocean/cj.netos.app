...
class _ZefyrEditableTextState extends State<ZefyrEditableText>
  ...
  Widget build(BuildContext context) {
    ...
    if(widget.buildChild!=null) {
      var child=widget.buildChild(body);
      if(child!=null) {
        body=child.child;
        align=child.align;
      }
    ...
    return MouseRegion(
      ...
      child: Stack(children: layers,alignment: align??Alignment.center,),
    );
  }
...
class EditorBuildChild{
  Alignment align;
  Widget child;

  EditorBuildChild({this.align, this.child});
}